...
--[[
  ...
  See GameMode:PostLoadPrecache() in gamemode.lua for more information
	...
	PrecacheModel("models/creeps/lane_creeps/creep_radiant_melee/radiant_melee_mega_crystal.vmdl", context)
	PrecacheModel("models/creeps/lane_creeps/creep_bad_melee/creep_bad_melee_mega_crystal.vmdl",context)
	PrecacheModel("models/creeps/lane_creeps/creep_2021_radiant/creep_2021_radiant_siege.vmdl", context)
	PrecacheModel("models/creeps/lane_creeps/creep_2021_dire/creep_2021_dire_siege.vmdl", context)
	PrecacheModel("models/creeps/neutral_creeps/n_creep_golem_b/n_creep_golem_b.vmdl", context)
	PrecacheModel("models/creeps/lane_creeps/creep_bird_radiant/creep_bird_radiant_siege.vmdl", context)
	PrecacheModel("models/creeps/lane_creeps/creep_bird_dire/creep_bird_dire_siege.vmdl", context)
	...
	PrecacheUnitByNameSync("npc_dota_hero_snapfire", context)
